<%@ Page Title="" Language="C#" MasterPageFile="~/LogueadoAcciones.master" AutoEventWireup="true" CodeFile="Publicacion.aspx.cs" Inherits="Publicacion" %>


<asp:Content ID="Content2" ContentPlaceHolderID="Cuerpo" Runat="Server">
    <div>
     <h1 class=" text-center Lato">  <%=txtTitulo%>  </h1>
     <h2 class=" text-center pacifico">Fin de publicación: <%=FechaHasta%>  // Podes alquilarlo por hasta <%=DiasFin%> dias </h2>
        <div id="cuerpo_public" class="center-block" >
            ...
            <p class=" text-center lato"><%=txtDescripcion%></p>
            </div>     
        </div>
    </div>
